...
#define SHKFacebookKey				@"136098559815437"
#define SHKFacebookSecret			@"da6becff3c6345087becda89b4a6c856"
 ...
 */
#define SHKTwitterConsumerKey		@"zL8D7LZGbeJUVTzZT7Y9g"
#define SHKTwitterSecret			@"IPHT1G8lDrLt3E1kvS3Ocm0ux3Sphwmd8z6PyoXWTlc"
#define SHKTwitterCallbackUrl		@"http://www.feelicity.es" // You need to set this if using OAuth, see note above (xAuth users can skip it)
